...
class HotelAdmin(admin.ModelAdmin):
    list_display = ['id','hotel_name', 'city','total_room', 'total_capacity', 'accomadate_space']
...
class HotelLocationAdmin(admin.ModelAdmin):
    ...
    list_editable = ['latitude', 'longitude', 'hotel']
...
admin.site.register(BroadcastNotification2)
